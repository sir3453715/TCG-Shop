...
class Card extends Model
{
    ...
    protected $fillable = [
        'lang', 'tw_id', 'name', 'hp', 'image', 'series_id', 'serial_number', 'attribute', 'type', 'skill', 'rarity',
        'competition_number', 'kingdom', 'weakpoint', 'weakpoint_value', 'resist', 'resist_value', 'escape', 'default_price',
    ];

    public function series()
    {
        return $this->belongsTo(CardSeries::class,'series_id');
    }
