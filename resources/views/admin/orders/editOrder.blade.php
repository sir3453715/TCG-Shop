...
@section('admin-page-content')
    ...
    <form id="create-Form" class="create-Form" action="{{ route('admin.order.update',['order'=>$order->id]) }}" method="post" enctype="multipart/form-data">
    @csrf
    @method('PUT')
    <!-- Main content -->
                                    ...
                                    <div class="col-12 row">
                                        <div class="col-12 col-md-4 row align-content-start">
                                            <div class="form-group col-6 col-md-12">
                                                ...
                                                <input type="text" class="form-control" name="seccode" id="seccode" placeholder="訂單編號" disabled value="{{$order->seccode}}">
                                            </div>
                                            <div class="form-group col-6 col-md-12">
                                            ...
                                            <div class="form-group col-6 col-md-12">
                                                ...
                                                <select name="payment" id="payment" class="form-control">
                                                    ...
                                                    @foreach($orderDefaultSetting['payment'] as $value => $payment)
                                                        <option value="{{$value}}" {!! $html->selectSelected($value,$order->payment) !!}>{{$payment['title']}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            <div class="form-group col-6 col-md-12">
                                                ...
                                                <select name="pay_status" id="pay_status" class="form-control">
                                                    <option value="" hidden>請選擇</option>
                                                    <option value="0" {!! $html->selectSelected(0,$order->pay_status) !!}>未付款</option>
                                        ...
                                        <div class="col-12 col-md-4  row align-content-start">
                                            <div class="form-group  col-6 col-md-12">
                                                ...
                                                <input type="text" class="form-control" name="buyer_name" id="buyer_name" placeholder="購買人姓名" value="{{$order->buyer_name}}">
                                            </div>
                                            <div class="form-group col-6 col-md-12">
                                                <label class="field-name" for="buyer_phone">購買人電話</label>
                                                <input type="text" class="form-control" name="buyer_phone" id="buyer_phone" placeholder="購買人電話" value="{{$order->buyer_phone}}">
                                            </div>
                                            <div class="form-group col-12 col-md-12">
                                                <label class="field-name" for="buyer_address">購買人地址</label>
                                                <input type="text" class="form-control" name="buyer_address" id="buyer_address" placeholder="購買人地址" value="{{$order->buyer_address}}">
                                            </div>
                                            <div class="form-group col-12 col-md-12">
                            ...
                            <div class="card-body">
                                <div class="form-group col-12">
                                    <table class="table-default table table-bordered w-100">
                                        ...
                                        <tbody id="item-tbody">
                                            @foreach($order->orderItemsSort() as $type => $orderItems)
                                                @foreach($orderItems as  $orderItem)
                                                    <tr>
                                                        <td><div class="d-flex"><input type="hidden" class="form-control" name="item_id[]" value="{{$orderItem['id']}}" readonly="">
                                                                <input type="hidden" class="form-control" id='item_card_id-{{$orderItem['card_id']}}' name="item_card_id[]" value="{{$orderItem['card_id']}}" readonly="">
                                                                <img src="{{$orderItem['image']}}" style="width: 40px"></div></td>
                                                        <td><input type="text" class="form-control" name="item_card_name[]" value="{{$orderItem['name']}}" readonly=""></td>
                                                        <td><input type="text" class="form-control" name="item_card_type[]" value="{{$type}}" readonly=""></td>
                                                        <td><input type="number" min="1" step="1" class="form-control item_change" id="number-{{$orderItem['card_id']}}" data-id="{{$orderItem['card_id']}}" name="item_number[]" value="{{$orderItem['number']}}"></td>
                                                        <td><input type="number" min="0" step="1" class="form-control item_change" id="unit_price-{{$orderItem['card_id']}}" data-id="{{$orderItem['card_id']}}" name="item_unit_price[]" value="{{$orderItem['unit_price']}}"></td>
                                                        <td><input type="number" min="1" step="1" class="form-control item_subtotal" id="subtotal-{{$orderItem['card_id']}}" data-id="{{$orderItem['card_id']}}" name="item_subtotal[]" value="{{$orderItem['subtotal']}}" disabled=""></td>
