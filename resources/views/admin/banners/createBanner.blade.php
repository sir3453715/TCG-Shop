...
@section('admin-page-content')
    ...
    <form id="create-Form" class="create-Form" action="{{ route('admin.banner.store') }}" method="post" enctype="multipart/form-data">
    @csrf
    <!-- Main content -->
                                    ...
                                    <div class="col-12 col-md-8">
                                        <div class="col-md-12 row">
                                            <div class="form-group col-12 col-md-6">
                                                ...
                                                <input type="text" class="form-control" name="title" id="title" placeholder="Banner標題">
                                            </div>
                                            <div class="form-group col-12 col-md-6">
                                                <label class="field-name" for="link">連結</label>
                                                <input type="text" class="form-control" name="link" id="link" placeholder="Banner連結">
                                            </div>
                                        </div>
                                    </div>
                                </div>
