...
@section('admin-page-content')
    ...
    <form id="create-Form" class="create-Form" action="{{ route('admin.series.store') }}" method="post" enctype="multipart/form-data">
    @csrf
    <!-- Main content -->
                                    ...
                                    <div class="col-12">
                                        <div class="col-md-12 row">
                                            <div class="form-group col-4">
                                                ...
                                                <input type="text" class="form-control" name="title" id="title" placeholder="分類標題">
                                            </div>
                                            <div class="form-group col-4">
                                                <label class="field-name" for="title">系列編號</label>
                                                <input type="text" class="form-control" name="serial_number" id="serial_number" placeholder="分類標題">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card-body">
                                <div class="col-12 row">
                                    ...
                                    <div class="form-group col-12">
                                        ...
                                        <input type="number" step="1" class="form-control" name="sort" id="sort" value="10">
                                    </div>
                                </div>
                            </div>
