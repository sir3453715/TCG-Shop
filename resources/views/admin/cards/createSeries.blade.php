...
@section('admin-page-content')
    ...
    <form id="create-Form" class="create-Form" action="{{ route('admin.eventClass.store') }}" method="post" enctype="multipart/form-data">
    @csrf
    <!-- Main content -->
