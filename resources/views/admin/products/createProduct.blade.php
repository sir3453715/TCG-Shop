...
@section('admin-page-content')
    ...
    <form id="create-Form" class="create-Form" action="{{ route('admin.product.store') }}" method="post" enctype="multipart/form-data">
    @csrf
    <!-- Main content -->
                            ...
                            <div class="card-body">
                                <div class="form-group row">
                                    <div class="col-12 col-md-3 row">
                                        ...
                                        <div class="col-6 col-md-12">
                                            <img id="cardSelectImg" class="w-100 p-3" src="/storage/image/Admin/SelectCardImageBackground.webp">
                                    ...
                                    <div class="col-12 col-md-9">
                                        <div class="col-md-12 row">
                                            <div class="form-group col-6 col-md-4">
                                                ...
                                                <input type="text" class="form-control" name="name" id="name" placeholder="卡牌名稱" disabled>
                                            </div>
                                            <div class="form-group col-6 col-md-4">
                                                <label class="field-name" for="price">卡牌金額</label>
                                                <input type="number" min="0" step="1" class="form-control" name="price" id="price" placeholder="產品金額">
                                            </div>
                                            <div class="form-group col-6 col-md-4">
                                                <label class="field-name" for="stock">庫存</label>
                                                <input type="number" min="0" step="1" class="form-control" name="stock" id="stock" placeholder="庫存">
                                            </div>
                                        </div>
                                    </div>
                                </div>
