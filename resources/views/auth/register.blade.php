    ...
    <div class="row justify-content-center">
            <h1 class="fs-40">註冊</h1>
                    ...
                    <div class="form-group row mb-3">
                            <label for="name" class="col-form-label text-md-right">{{ __('用戶ID') }}</label>
                            <div class="col">
                                <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" required autocomplete="name" autofocus placeholder="請輸入用戶ID">
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col">
                                <input id="password-confirm" type="password" class="form-control" name="password_confirmation" required autocomplete="new-password" placeholder="卻認密碼">
                            </div>
                        </div>
